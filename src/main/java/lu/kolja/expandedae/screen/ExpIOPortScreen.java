...
public class ExpIOPortScreen extends UpgradeableScreen<IOPortMenu> {
    ...
    public ExpIOPortScreen(IOPortMenu menu, Inventory playerInventory, Component title, ScreenStyle style) {
