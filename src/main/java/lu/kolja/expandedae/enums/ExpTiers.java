...
public enum ExpTiers implements ICraftingUnitType, Serializable, IExtensibleEnum {
    ...
    @Override
    public @NotNull Item getItemFromType() {
        return getDefinition().asItem();
    }

    @Contract(" -> new")
    public static @NotNull ExtensionInfo getExtensionInfo() {
        return ExtensionInfo.nonExtended(ExpTiers.class);
    }
}